...
def step_impl(context):
    context.driver.find_element(
        By.XPATH, '//*[@id="sidebar-nav"]/li[3]/a').click()
    time.sleep(2)
...
def step_impl(context):
    context.driver.find_element(
        By.XPATH, '//*[@id="components-nav"]/li[1]/a').click()
...
def step_impl(context, fecha, cotizacion, servicio, falla, indicaciones, equipo):
    ...
    context.driver.find_element(
        By.NAME, 'indicaciones_adicionales').send_keys(indicaciones)
...
def step_impl(context):
    context.driver.find_element(
        By.XPATH, '//*[@id="main"]/form/button').click()
