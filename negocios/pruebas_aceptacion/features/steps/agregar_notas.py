...
def step_impl(context):
    context.driver.find_element(
        By.XPATH, '//*[@id="components-nav"]/li[2]/a/span').click()
...
def step_impl(context):
    ...
    div = context.driver.find_element(
        By.XPATH, '//*[@id="main"]/table/thead/tr/th[5]')
    time.sleep(5)
...
def step_impl(context, observaciones):
    context.driver.find_element(
        By.NAME, 'observaciones_notas').send_keys(observaciones)
...
def step_impl(context):
    ...
    boton_guardar = context.driver.find_element(
        By.XPATH, "//button[@type='submit' and contains(text(), 'Guardar')]")
