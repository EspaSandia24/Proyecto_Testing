...
def step_impl(context):
    context.driver.find_element(
        By.XPATH, '//*[@id="sidebar-nav"]/li[7]/a').click()
    time.sleep(3)
...
def step_impl(context):
    context.driver.find_element(
        By.XPATH, '/html/body/main/div/section/div/div/div/div[2]/div/form/div[4]/button').click()
...
def step_impl(context):
    ...
    time.sleep(5)
    assert Nombre in div.text, f"El usuario {
        Nombre} no se encuentra en {div.text}"
...
def step_impl(context, mensaje):
    div = context.driver.find_element(
        By.XPATH, '/html/body/main/div/section/div/div/div/div[2]/div/form/div[1]/div/div')
    time.sleep(5)
    assert mensaje in div.text, f"El usuario {
        mensaje} no se encuentra en {div.text}"
...
def step_impl(context):
    ...
    div = context.driver.find_element(
        By.XPATH, '/html/body/main/div/section/div/div/div/div[2]/div/div/h5')
    time.sleep(5)
    assert Nombre in div.text, f"El usuario {
        Nombre} no se encuentra en {div.text}"
...
def step_impl(context, mensaje):
    div = context.driver.find_element(
        By.XPATH, '/html/body/main/div/section/div/div/div/div[2]/div/form/div[2]/div')
    time.sleep(5)
    assert mensaje in div.text, f"El usuario {
        mensaje} no se encuentra en {div.text}"
