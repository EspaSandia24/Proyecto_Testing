Característica: Eliminar
Como usuario del sistema Altas MFC 
quiero poder eliminar los equipos y ordenes
para poder conservar espacio

Escenario: Eliminar el equipo con sn A45789
...
Cuando presiono el botón eliminar con el numero de serie "A45789"
